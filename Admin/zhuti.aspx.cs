...
public partial class Admin_zhuti : System.Web.UI.Page
{
    ...
    public DataSet Getnews()
    {
        ...
        string cmdText = "SELECT * FROM tb_PostMsg  ORDER BY id DESC";
    ...
    {
        SqlConnection myConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["connStr"].ConnectionString);
        string cmdText = "DELETE FROM tb_PostMsg WHERE id=" + nNewsID;
