<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="addnews.aspx.cs" Inherits="Admin_addnews" Title="Untitled Page" %>
        ...
        <tr>
            ...
            <td align="left" bgcolor="#fff5e1" colspan="3" style="height: 24px" valign="middle">
                <asp:TextBox ID="titles" runat="server" Style="border-right: #ffcc00 1px solid; border-top: #ffcc00 1px solid;
                    border-left: #ffcc00 1px solid; border-bottom: #ffcc00 1px solid" Width="743px"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right" bgcolor="#fff5e1" style="width: 68px; height: 222px" valign="middle">
                内容</td>
            <td align="left" bgcolor="#fff5e1" colspan="1" style="width: 2px; height: 222px"
                valign="top">
            </td>
            <td align="left" bgcolor="#fff5e1" colspan="3" style="height: 222px" valign="top">
