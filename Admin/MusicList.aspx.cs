...
using System.IO;
public partial class Admin_MoveList : System.Web.UI.Page
{
    ...
    protected void gvFilms_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string ID = gvFilms.DataKeys[e.RowIndex].Values[0].ToString();
        try
        {
            mydata.RunSql("delete  from Music  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Music]  ";
