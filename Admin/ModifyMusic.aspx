<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ModifyMusic.aspx.cs" Inherits="Admin_ModifyMove" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table bgcolor="#fbd79f" border="0" cellpadding="0" cellspacing="1" height="280"
        ...
        <tr>
            <td align="right" bgcolor="#fff5e1" style="width: 68px" valign="middle">
                歌曲描述</td>
