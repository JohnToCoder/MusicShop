<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Musictype.aspx.cs" Inherits="Admin_Movetype" Title="Untitled Page" %>
    ...
    <table bgcolor="#fbd79f" border="0" cellpadding="0" cellspacing="1" style="height: 138px"
        ...
        <tr>
            <td align="center" bgcolor="#ccffff" colspan="5" style="height: 24px" valign="middle">
                <span style="background-color: #fff5e1">歌曲类别管理</span></td>
        </tr>
        <tr>
