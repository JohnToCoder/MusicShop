<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="huifu.aspx.cs" Inherits="Admin_huifu" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center" colspan="2" style="height: 19px">
                <asp:GridView ID="NewsGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    OnRowDeleting="NewsGridView_RowDeleting" PageSize="15" Width="100%">
                    <PagerSettings Mode="NumericFirstLast" />
                    <RowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="ReTitle" HeaderText="回复主题" HtmlEncode="False">
                        ...
                        <asp:BoundField DataField="ReTime" HeaderText="发帖时间" HtmlEncode="False" />
